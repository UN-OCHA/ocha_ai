...
class LocalizationHelper {
   ...
   */
  public static function collatedAsort(array &$items, ?string $property = NULL, ?string $language = NULL): bool {
    if (empty($items)) {
      return TRUE;
    }
   ...
   *   TRUE on success or FALSE on failure.
   */
  public static function collatedSort(array &$items, $property = NULL, $language = NULL): bool {
    if (empty($items)) {
      return TRUE;
    }
   ...
   *   TRUE on success or FALSE on failure.
   */
  public static function collatedKsort(array &$items, $language = NULL): bool {
    if (empty($items)) {
      return TRUE;
    }
   ...
   *   Formatted number.
   */
  public static function formatNumber(float|int $number, ?string $language = NULL): string {
   ...
   */
  public static function getCollator(?string $language = NULL): \Collator|FALSE {
   ...
   */
  protected static function getNumberFormatter(?string $language = NULL): \NumberFormatter|FALSE {
    $language = static::getLanguage($language);
   ...
   */
  protected static function createCollator(string $language): \Collator|FALSE {
   ...
   */
  protected static function createNumberFormatter(string $language): \NumberFormatter|FALSE {
   ...
   *   Error code.
   */
  protected static function intlGetErrorCode(): int {
   ...
   *   ISO2 language code.
   */
  public static function getLanguage(?string $language = NULL): string {
    if (empty($language)) {
